...
## Office hours change
As no one comes to my office hour before the lecture, I'm going to change it from that reguarly scheduled time, to by appointment. If you have anything that you'd like to discuss then please email me and we can work out a time that suits.
...
- Meet tomorrow at noon in Room 507, Bissell Building with Arik speaking.
- All invited, see https://rohanalexander.com/brownbag.html for more details.
...
A good resource is part 1 (especially chapters 3 and 7) of 'R for Data Science' by Hadley Wickham, available for free here: https://r4ds.had.co.nz/. DO THE READINGS.

<!-- ## What to hand in via GitHub -->

<!-- **There are exercises at the end of this lab**. Please make a new .Rmd file with your answers, call it something sensible (e.g. `week_2_lab.Rmd`), commit to your git repo from last week, and push to GitHub. This is due tomorrow (16 January 2020) by 5pm.  -->

## A note on RStudio projects
...
#class(table(delay_2019$day)) is table

delay_2019%>%
  select(day)%>%
  table()#class would be dataframe
```
